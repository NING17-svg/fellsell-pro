# Fell & Sell Guide (fellsell.pro)

This is the V3 production site for **Fell & Sell** (domain `fellsell.pro`),
generated by the `one-click-builder` role from the shared V3 game-guide
template. The site delivers the approved Site Plan, V3 content package, and
dark forge-and-merchant theme as an indexable, public game guide.
